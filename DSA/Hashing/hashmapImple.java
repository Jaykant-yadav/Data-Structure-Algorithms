...
public class hashmapImple {
    static class HashMap<K, V> { // generic -> all types of data type compatable
        private class Node {
            K key;
            V value;
        ...
        private int n; // n -> total number of nodes/pairs
        private int N;
        private LinkedList<Node> buckets[]; // N = buckets.length -> total number of buckets Array
